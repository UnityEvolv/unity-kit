...
export type ColorToken = 'bg' | 'surface' | 'surface-raised' | 'line' | 'ink' | 'muted' | 'primary' | 'primary-hover' | 'primary-ink' | 'secondary' | 'secondary-ink' | 'status-ink' | 'ok' | 'warn' | 'danger' | 'info' | 'focus'
